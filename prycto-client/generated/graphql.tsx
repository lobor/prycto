...
export type AddExchangeMutation = { __typename?: "Mutation" } & {
  addExchange: { __typename?: "Exchange" } & Pick<
    Exchange,
    "name" | "exchange" | "publicKey" | "secretKey" | "_id"
  >;
};
...
export type AddPositionMutation = { __typename?: "Mutation" } & {
  addPosition: { __typename?: "Position" } & Pick<
    Position,
    "_id" | "pair" | "investment" | "objectif"
  >;
};
...
export type BalancesByExchangeIdQuery = { __typename?: "Query" } & {
  exchangeById: { __typename?: "Exchange" } & Pick<Exchange, "_id" | "balance">;
};
...
export type EditPositionMutation = { __typename?: "Mutation" } & {
  editPosition: { __typename?: "Position" } & Pick<
    Position,
    "_id" | "objectif"
  >;
};
...
export type ExchangeByIdQuery = { __typename?: "Query" } & {
  exchangeById: { __typename?: "Exchange" } & Pick<
    Exchange,
    "name" | "_id" | "exchange"
  >;
};
...
export type ExchangesQuery = { __typename?: "Query" } & {
  exchanges: Array<
    { __typename?: "Exchange" } & Pick<Exchange, "name" | "_id">
  >;
};
...
export type GetHistoryBySymbolQuery = { __typename?: "Query" } & {
  getHistoryBySymbol: Array<
    { __typename?: "Cours" } & Pick<Cours, "_id" | "timestamp" | "close">
  >;
};
...
export type GetHistoryOrderBySymbolQuery = { __typename?: "Query" } & {
...
export type GetMarketsQuery = { __typename?: "Query" } & Pick<
  Query,
  "getMarkets"
>;
...
export type GetPairsQuery = { __typename?: "Query" } & {
  getPairs: Array<{ __typename?: "Pair" } & Pick<Pair, "symbol">>;
};
...
export type MarketHitSubscription = { __typename?: "Subscription" } & Pick<
  Subscription,
  "marketHit"
>;
...
export type PredictQuery = { __typename?: "Query" } & {
  predict: { __typename?: "Predict" } & Pick<Predict, "up" | "down">;
};
...
export type RemoveExchangeMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "removeExchange"
>;
...
export type RemovePositionMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "removePosition"
>;
...
export type SyncPositionsMutation = { __typename?: "Mutation" } & {
  syncPositions: { __typename?: "Position" } & Pick<Position, "_id">;
};
...
export type UpdateLangMutation = { __typename?: "Mutation" } & {
  updateLang: { __typename?: "User" } & Pick<User, "_id" | "lang">;
};
...
export type UpdatePasswordMutation = { __typename?: "Mutation" } & {
  updatePassword: { __typename?: "User" } & Pick<User, "_id">;
};
...
export type UpdateUserMutation = { __typename?: "Mutation" } & {
  updateUser: { __typename?: "User" } & Pick<User, "_id" | "email">;
};

export type UserQueryVariables = Exact<{ [key: string]: never }>;

export type UserQuery = { __typename?: "Query" } & {
  user: { __typename?: "User" } & Pick<User, "_id" | "email" | "lang">;
};
...
`;
export type AddExchangeMutationFn = Apollo.MutationFunction<
  AddExchangeMutation,
  AddExchangeMutationVariables
>;
export type AddExchangeMutationResult =
  Apollo.MutationResult<AddExchangeMutation>;
export type AddExchangeMutationOptions = Apollo.BaseMutationOptions<
  AddExchangeMutation,
  AddExchangeMutationVariables
>;
...
`;
export type AddPositionMutationFn = Apollo.MutationFunction<
  AddPositionMutation,
...
`;
export type BalancesByExchangeIdQueryResult = Apollo.QueryResult<
...
>;
export type EditPositionMutationResult =
  Apollo.MutationResult<EditPositionMutation>;
...
`;
export type ExchangeByIdQueryResult = Apollo.QueryResult<
  ExchangeByIdQuery,
  ExchangeByIdQueryVariables
>;
...
`;
export type ExchangesQueryResult = Apollo.QueryResult<
  ExchangesQuery,
...
`;
export type GetHistoryBySymbolQueryResult = Apollo.QueryResult<
  GetHistoryBySymbolQuery,
  GetHistoryBySymbolQueryVariables
>;
...
`;
export type GetHistoryOrderBySymbolQueryResult = Apollo.QueryResult<
...
`;
export type GetPairsQueryResult = Apollo.QueryResult<
  GetPairsQuery,
...
`;
export type MarketHitSubscriptionResult =
  Apollo.SubscriptionResult<MarketHitSubscription>;
...
export const PredictDocument = gql`
  query predict($exchangeId: String!, $symbol: String!) {
    predict(exchangeId: $exchangeId, symbol: $symbol) {
      up
      down
    }
  }
`;
export type PredictQueryResult = Apollo.QueryResult<
  PredictQuery,
...
`;
export type RemoveExchangeMutationFn = Apollo.MutationFunction<
  RemoveExchangeMutation,
  RemoveExchangeMutationVariables
>;
export type RemoveExchangeMutationResult =
  Apollo.MutationResult<RemoveExchangeMutation>;
export type RemoveExchangeMutationOptions = Apollo.BaseMutationOptions<
  RemoveExchangeMutation,
  RemoveExchangeMutationVariables
>;
...
`;
export type RemovePositionMutationFn = Apollo.MutationFunction<
  RemovePositionMutation,
  RemovePositionMutationVariables
>;
export type RemovePositionMutationResult =
  Apollo.MutationResult<RemovePositionMutation>;
export type RemovePositionMutationOptions = Apollo.BaseMutationOptions<
  RemovePositionMutation,
  RemovePositionMutationVariables
>;
...
`;
export type SyncPositionsMutationFn = Apollo.MutationFunction<
  SyncPositionsMutation,
  SyncPositionsMutationVariables
>;
export type SyncPositionsMutationResult =
  Apollo.MutationResult<SyncPositionsMutation>;
export type SyncPositionsMutationOptions = Apollo.BaseMutationOptions<
  SyncPositionsMutation,
  SyncPositionsMutationVariables
>;
...
`;
export type UpdateLangMutationFn = Apollo.MutationFunction<
  UpdateLangMutation,
  UpdateLangMutationVariables
>;
export type UpdateLangMutationResult =
  Apollo.MutationResult<UpdateLangMutation>;
export type UpdateLangMutationOptions = Apollo.BaseMutationOptions<
  UpdateLangMutation,
  UpdateLangMutationVariables
>;
