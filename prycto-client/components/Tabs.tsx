...
const Tabs = () => {
  ...
  return (
    // <div className="flex-1 order-last md:order-none bottom-0 overflow-x-auto content-center md:content-start text-left">
    <ul className="w-1 flex order-last bottom-0 md:order-none flex-grow flex-row py-0 pt-0 overflow-x-auto px-1 content-center md:content-start text-left">
